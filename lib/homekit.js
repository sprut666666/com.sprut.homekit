...
function configServer(homey) {
  ...
  // Config for server
  const config = new HAS.Config(homey.hostname, homey.wifi_mac, HAS.categories.bridge, '../userdata/homey.json', 8090, '620-55-841');
  ...
  const serialNumber = HAS.predefined.SerialNumber(5, '4BFZDSPV4XJHF');
