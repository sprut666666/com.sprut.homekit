...
var Characteristic = (function () {
    ...
    Characteristic.prototype.getValue = function (parse) {
    ...
    Characteristic.prototype.isValid = function (value) {
        ...
        if (this.isNumeric()) {
            ...
            if (this.validValues && this.validValues.indexOf(value) <= -1)
                return false;
            var range = this.validRangeValues || defaultRanges[this.valueFormat];
    ...
    Characteristic.prototype.floatSafeRemainder = function (value, step) {
        value = parseFloat(value);
        if (isNaN(value))
            return 1;
        var valDecCount = (value.toString().split('.')[1] || '').length;
        var stepDecCount = (step.toString().split('.')[1] || '').length;
        var decCount = valDecCount > stepDecCount ? valDecCount : stepDecCount;
        var valInt = parseInt(value.toFixed(decCount).replace('.', ''));
        var stepInt = parseInt(step.toFixed(decCount).replace('.', ''));
        return (valInt % stepInt) / Math.pow(10, decCount);
    };
    Characteristic.prototype.getIntDefaultValue = function (value) {
    ...
    Characteristic.prototype.prepareValue = function (value) {
        if (!this.isSet(value))
            return value;
        var finalValue;
        if (this.isNumeric())
    ...
    Characteristic.prototype.isSet = function (value) {
