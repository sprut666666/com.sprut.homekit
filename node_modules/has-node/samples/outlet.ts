...
const config = new HAS.Config('NodeJS Outlet', '47:E6:B6:63:BC:2C', HAS.categories.outlet, __dirname + '/outlet.json', 8094, '200-20-200');

const server = new HAS.Server(config);

const outlet = new HAS.Accessory(1);

const outletIdentify = HAS.predefined.Identify(1, undefined, (value, callback) => {
...
const inUse = HAS.predefined.OutletInUse(2, false);
