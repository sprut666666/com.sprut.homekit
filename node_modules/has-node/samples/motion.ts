...
const config = new HAS.Config('NodeJS Motion Sensor', '49:E6:B6:63:BC:2C', HAS.categories.sensor, __dirname + '/motion.json', 8095, '200-20-200');

const server = new HAS.Server(config);

const motion = new HAS.Accessory(1);

const motionIdentify = HAS.predefined.Identify(1, undefined, (value, callback) => {
...
const motionDetected = HAS.predefined.MotionDetected(2, false);
