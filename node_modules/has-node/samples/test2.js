...
const config = new HAS.Config('NodeJS Outlet222', '47:E1:B6:63:BC:7C', HAS.categories.outlet, __dirname + '/outlet.json', 8094, '200-20-200');
...
const on = HAS.predefined.On(1, undefined, (value, callback) => {
